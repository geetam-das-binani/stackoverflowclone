...
const RegisterPage = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-md rounded-none
     border border-solid border-gray/30 bg-white p-4 
    ...
    <form className="my-8" action={handleRegister}>
        <div className="mb-4 flex
         flex-col space-y-3 md:flex-row md:space-x-2 md:space-y-0">
            <LabelInputContainer>
                <Label htmlFor="firstName">First name</Label>
                <Input 
                className="text-black" id="firstname" 
                name="firstname" placeholder="Tyler" type="text" />
            </LabelInputContainer>
            <LabelInputContainer>
